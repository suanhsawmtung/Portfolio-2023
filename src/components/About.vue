<template>
    <section id="about" class="w-screen 2xl:max-w-[1440px] pt-28 sm:pb-28 pb-6 lg:min-h-screen flex flex-col flex-wrap lg:flex-row justify-between gap-8 lg:gap-0 lg:gap-y-5 bg-[#030712] overflow-x-hidden">
        <div class="w-full lg:w-2/6 h-auto lg:h-full ps-6 md:ps-16 lg:ps-0 flex justify-start lg:justify-center items-start">
            <div class="w-11/12 sm:w-1/3 lg:w-4/6 h-auto overflow-hidden rounded-lg section-observer opacity-0 -translate-x-40 duration-1000">
        ...
        <div class="w-full lg:w-4/6 lg:h-full flex items-start">
            <div class="w-full px-6 md:ps-16 lg:ps-0 md:pe-16 text-white">
                <Header
                    ...
                    class="section-observer opacity-0 duration-700"
                >
                    Who am I? As I mentioned above, my name is Suanh Sawm Tung.
                </Header>
                <Header v-else class="section-observer opacity-0 duration-700">
                    About Me!
                </Header>
                <Description class="section-observer translate-y-5 opacity-0 duration-700 delay-75">
                ...
                <Description class="section-observer translate-y-5 opacity-0 duration-700 delay-150">
                ...
                <Description class="section-observer translate-y-5 opacity-0 duration-700 delay-200">
        ...
        <div class="w-full text-white lg:w-2/6 h-auto px-6 md:px-16 lg:px-0 lg:pe-8 flex justify-start lg:justify-end items-start">
            <div class="w-full lg:w-5/6 h-auto overflow-hidden section-observer translate-y-10 opacity-0 duration-1000 delay-75">
        ...
        <div class="w-full text-white lg:w-2/6 h-auto px-6 md:px-16 lg:px-0 lg:pe-8 flex justify-start items-start">
            <div class="w-full h-auto overflow-hidden section-observer translate-y-10 opacity-0 duration-1000 delay-150">
        ...
        <div class="w-full text-white lg:w-2/6 h-auto px-6 md:px-16 lg:px-0 lg:pe-8 flex justify-start items-start">
            <div class="w-full lg:w-5/6 h-auto overflow-hidden section-observer translate-y-10 opacity-0 duration-1000 delay-200">
